...
const products = [
  ...
  { name: "Cologne Supplier", price: "$11.99", old: "$19.99", image: productCologne, priceId: "price_1TGvH6Pkl9P0JJ5q4mg7eLmk" },
  { name: "Puffer Jacket Supplier", price: "$11.99", old: "$19.99", image: productPuffer, priceId: "price_1TGvIwPkl9P0JJ5qVtH9gE7c" },
];
