...
const faqs = [
  { q: "How much does it cost?", a: "Our supplier lists start at just $11.99 CAD. The all-in-one bundle is $25.99 CAD — a fraction of what you'd pay elsewhere." },
  ...
  { q: "How much do the suppliers charge for a product?", a: "Prices range from $10–$200 CAD depending on the product category. You'll find detailed pricing in each supplier list." },
