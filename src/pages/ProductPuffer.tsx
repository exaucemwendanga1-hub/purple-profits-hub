...
const ProductPuffer = () => (
  <ProductPageLayout
    name="Puffer Jacket Supplier List"
    price="$11.99"
    oldPrice="$19.99 CAD"
    discount="40%"
    ...
    features={[
      { icon: Wind, title: "Trending Styles", desc: "Access suppliers with the latest puffer jacket designs and trending outerwear." },
    ...
    faqs={[
      { q: "What types of jackets are covered?", a: "Our list includes suppliers for trending puffer jackets, designer outerwear, and premium winter styles." },
